...
export const Lab3CartPage = (props: Lab3CartPageProps) => {
  ...
  const sortedFilteredProducts = products
    ...
    .filter((product) => inCart(product.id));
    ...
    <Container className="container__md">
      ...
      {props.cart.size !== 0 ? (
        ...
        <>
          ...
          <p>
            You can use the button below to return to the Products page and add
      ...
      <Row>
        <Col>
          <Button variant="secondary" as={Link} to="/lab3/products">
            Back to Products
          </Button>{" "}
          {props.cart.size !== 0 ? (
            <Button
