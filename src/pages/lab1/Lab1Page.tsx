          ...
          <Col>
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  This evaluation form is to evaluate the website linked below.
                  Please have the website open as you fill out this survey.
                </Card.Text>
            ...
            <Form className="mt-3">
              ...
              <Form.Group controlId="formSelectUsability">
                <Form.Label>
                  On a scale of 1-5, how would you rate the <b>usability</b> of
                  the website?
                </Form.Label>
              ...
              <Form.Group controlId="formSelectConsistency">
                <Form.Label>
                  On a scale of 1-5, how would you rate the <b>consistency</b>{" "}
                  of the website?
                </Form.Label>
                <Form.Control as="select">
                  <option selected>Select one...</option>
              ...
              <Form.Group controlId="formMajorUiElements">
                <Form.Label>
                  Select the major UI elements that the website implements.
                </Form.Label>
              ...
              <Form.Group controlId="formOverallSatisfaction">
                <Form.Label>
                  Overall, would you say that the website has a good UI?
                </Form.Label>
                <Form.Check
                  label="Yes"
                  type="radio"
                  name="formOverallSatisfaction"
                />
                <Form.Check
                  label="No"
                  type="radio"
